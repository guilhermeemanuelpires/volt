import { createHTML, copyFromAssets, processLocalImage } from "../util/pdf";

export const simpleHtml = (sholudRemovePageMargin = true) => () => createHTML();
